...
def generate_launch_description():
    ...
    pkg_ros_ign_gazebo = get_package_share_directory(
        'ros_ign_gazebo')
    pkg_create3_sim_total = get_package_share_directory(
        'create3_sim_total')
    pkg_create3_lidar = get_package_share_directory(
        'create3_lidar')
    ...
    # Create3 lidar SLAM launch
    create3_lidar_slam = IncludeLaunchDescription(
        PythonLaunchDescriptionSource([create3_lidar_slam_launch])
    )
